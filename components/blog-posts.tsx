  ...
  return (
    <div className="space-y-8">
      {posts.slice().reverse().map((post) => (
        ...
        >
          <div className="text-sm text-zinc-500 dark:text-zinc-400">{format(new Date(post.date), "MMMM d, yyyy")}</div>
          <div>
            <div
            ...
            <div className={cn("media-container", openPostId === post.id && "open")}>
              <div className="pt-4">
